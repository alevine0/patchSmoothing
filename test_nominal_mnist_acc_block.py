...
parser.add_argument('--block_size', default=4, type=int, help='number of bands')
...
def test():
    ...
    with torch.no_grad():
        for batch_idx, (inputs, targets) in enumerate(testloader):
            ...
            outputs = net(utils.random_mask_batch_one_sample(inputs, args.block_size, reuse_noise=False))
