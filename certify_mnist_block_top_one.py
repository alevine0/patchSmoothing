...
import os
import argparse
import utils_block_top_one as utils
...
def test():
    ...
    with torch.no_grad():
        for batch_idx, (inputs, targets) in enumerate(testloader):
            ...
            predictions,  certyn = utils.predict_and_certify(inputs, net,args.block_size, args.size_to_certify, 10)
    ...
    print('Using block size ' + str(args.block_size))
