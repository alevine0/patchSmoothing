...
checkpoint_file = f'./{checkpoint_dir}/tmnist_one_band_lr_{args.lr}_regularization_{args.regularization}_band_{args.band_size}_epoch_{{}}.pth'
...
if args.resume:
    ...
    checkpoint_file = './{}/tmnist_one_band_lr_{}_regularization_{}_band_{}_epoch_{}_resume_{}.pth'.format(checkpoint_dir, args.lr,args.regularization, args.band_size,'{}', args.resume)
