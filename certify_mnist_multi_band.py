...
def test():
    ...
    with torch.no_grad():
        for batch_idx, (inputs, targets) in enumerate(testloader):
            ...
            predictions,  certyn = utils.predict_and_certify(inputs, net,args.keep, args.bandwidth, args.size_to_certify, 10,threshold =  args.threshhold)
    ...
    print('Band size: '  + str(args.bandwidth) + ' threshhold: ' + str(args.threshhold) + ' num bands: ' + str(args.keep))
