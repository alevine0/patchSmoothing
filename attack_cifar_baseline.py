...
parser.add_argument('--randomizations', default=80, type=int, help='Number of random restarts')
...
def test():
    ...
    for batch_idx, (inputs, targets) in enumerate(testloader):
        ...
        save_image(make_grid(inputs, nrow=10),"baseline_baseline_"+str(batch_idx)+".jpg")
        ...
        save_image(make_grid(attacked, nrow=10),"attacks_baseline_"+str(batch_idx)+".jpg")
