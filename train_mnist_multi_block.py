...
import utils_multi_block as utils

parser = argparse.ArgumentParser(description='PyTorch MNIST Training')
parser.add_argument('--lr', default=0.01, type=float, help='learning rate')
parser.add_argument('--block_size', default=4, type=int, help='block size')
parser.add_argument('--keep', default=4, type=int, help='number to keep')
...
checkpoint_file = f'./{checkpoint_dir}/mnist_block_fixed_exact_lr_{args.lr}_regularization_{args.regularization}_block_{args.block_size}_keep_{args.keep}_epoch_{{}}.pth'
...
if args.resume:
    ...
    checkpoint_file = './{}/mnist_block_fixed_exact_lr_{}_regularization_{}_block_{}_keep_{}_epoch_{}_resume_{}.pth'.format(checkpoint_dir, args.lr,args.regularization, args.block_size,args.keep,'{}', args.resume)
...
def train(epoch):
    ...
    for batch_idx, (inputs, targets) in enumerate(trainloader):
        ...
        optimizer.zero_grad()
        outputs = net(utils.random_mask_batch_one_sample(inputs, args.keep,args.block_size, reuse_noise=True))
